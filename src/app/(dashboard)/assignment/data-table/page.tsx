...
const AssignmentDetail = () => {
  ...
  const name = searchParams.get("nameAssignment")?.split("/").pop();  const [documents, setDocuments] = useState<any[]>([]);
  ...
  return (
    <div className='mx-auto my-6 w-full max-w-6xl rounded border'>
      <div className='p-4 border-b'>
        ...
        <Button className='ml-2 mt-4 inline-block bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600'>
          Bagikan link share
        </Button>
        <Input
